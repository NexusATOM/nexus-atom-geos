> Historical standalone release record. Current package setup is in [readiness](../READINESS.md).
...
[Actions page](https://github.com/NexusATOM/nexus-atom-geos/actions).
