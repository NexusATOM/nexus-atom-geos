...
site wrapper. The agent command runner delegates scheduler behavior to those wrappers.
The separate ATOM plugin uses the shared HPC Slurm adapter, whose Discover
